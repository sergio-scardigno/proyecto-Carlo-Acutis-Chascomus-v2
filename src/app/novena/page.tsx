...
const openingPrayer = [
	"Santisima Trinidad, Padre, Hijo y Espiritu Santo, te adoro profundamente y te doy gracias por todos los favores y las gracias con las que has enriquecido el alma del Beato Carlo Acutis durante sus 15 anos vividos en esta tierra y, por los meritos de este amado angel de la juventud, concedeme la gracia que ardientemente te pido.",
	"(Se dice la gracia que se desea alcanzar).",
];

const closingPrayer = [
	"Dios Padre de misericordia, eleva a la gloria de los altares al Beato Carlo Acutis, para que por medio de el Tu seas cada vez mas glorificado.",
...
const novenaDays: NovenaDay[] = [
	{
		...
		reflection: "Beato Carlo Acutis, que has hecho de tu vida una continua renuncia y anonadamiento...",
		prayer: commonRosaryText,
		image: "/img/oracion/primer_dia.jpg",
		imageAlt: "Meditacion del primer dia de la novena al Beato Carlo Acutis",
	},
	{
		...
		reflection: "Beato Carlo Acutis, que has vivido siempre unido al Corazon de Jesus...",
		prayer: commonRosaryText,
		image: "/img/oracion/segundo_dia.jpg",
		imageAlt: "Meditacion del segundo dia de la novena al Beato Carlo Acutis",
	},
	{
		...
		quote:
			"Pide continuamente ayuda a tu Angel de la guarda, pues el tiene que llegar a ser tu mejor amigo.",
		reflection:
			"Beato Carlo Acutis, que has buscado, ya en este mundo, la compania de los Santos Angeles, alcanzame la gracia de vivir con rectitud, como te lo inspiro tu Angel. Amen.",
		prayer: commonRosaryText,
		image: "/img/oracion/tercer_dia.jpg",
		imageAlt: "Meditacion del tercer dia de la novena al Beato Carlo Acutis",
	},
	{
		...
		reflection:
			"Beato Carlo Acutis, que has vivido tan bien este Sacramento de la Reconciliacion, alcanzame la gracia de acercarme con frecuencia a la confesion con un arrepentimiento profundo. Amen.",
		prayer: commonRosaryText,
		image: "/img/oracion/cuarto_dia.jpg",
		imageAlt: "Meditacion del cuarto dia de la novena al Beato Carlo Acutis",
	},
	{
		...
		reflection:
			"Beato Carlo Acutis, que nunca has apartado la mirada de Jesus, tu gran amor, alcanzame la gracia de vivir ya en este mundo esta felicidad autentica. Amen.",
		prayer: commonRosaryText,
		image: "/img/oracion/quinto_dia.jpg",
		imageAlt: "Meditacion del quinto dia de la novena al Beato Carlo Acutis",
	},
	{
		...
		reflection:
			"Beato Carlo Acutis, que siempre has sabido pedir a Dios lo esencial, alcanzame la gracia de un profundo deseo del Cielo. Amen.",
		prayer: commonRosaryText,
		image: "/img/oracion/sexto_dia.jpg",
		imageAlt: "Meditacion del sexto dia de la novena al Beato Carlo Acutis",
	},
	{
		...
		reflection:
			"Beato Carlo Acutis, que has amado a la Virgen Maria mas que a nadie, alcanzame la gracia de responder siempre al amor de esta Madre tan dulce y tan buena. Amen.",
		prayer: commonRosaryText,
		image: "/img/oracion/septimo_dia.jpg",
		imageAlt: "Meditacion del septimo dia de la novena al Beato Carlo Acutis",
	},
	{
		...
		reflection:
			"Beato Carlo Acutis, que buscabas siempre a tu Jesus oculto en el Sagrario, alcanzame la gracia de un profundo fervor eucaristico. Amen.",
		prayer: commonRosaryText,
		image: "/img/oracion/octavo_dia.jpg",
		imageAlt: "Meditacion del octavo dia de la novena al Beato Carlo Acutis",
	},
	{
		...
		quote:
			"Muero sereno, porque no he vivido ni siquiera un minuto de mi vida en cosas que no agradan a Dios.",
		reflection:
			"Beato Carlo Acutis, alcanzame la gracia de las gracias, o sea la perseverancia final y una muerte santa. Amen.",
		prayer: commonRosaryText,
		image: "/img/oracion/noveno_dia.jpg",
		imageAlt: "Meditacion del noveno dia de la novena al Beato Carlo Acutis",
	},
];
	...
	return (
		<main className="page-shell">
			<div className="page-content max-w-4xl">
				<PageHeader
					title="Novena al Beato Carlo Acutis"
